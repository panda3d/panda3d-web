...
function panda3d_scripts() {
	// Vendor
	wp_enqueue_script( 'jquery', '//ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js', array(), '20180518', true );
	wp_enqueue_script( 'fontawesome', get_template_directory_uri() . '/assets/js/vendor/fontawesome-all.min.js', array(), '20180612', true );
